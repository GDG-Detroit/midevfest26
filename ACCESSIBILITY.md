...
This document outlines the accessibility standards and practices for the Michigan DevFest website. Our goal is to ensure the website is accessible to all users, including those using assistive technologies.
